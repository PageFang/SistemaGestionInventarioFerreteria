                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="telefono" type="text" placeholder="3152459270" />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="iniciarSesion.php">Tienes una Cuenta ? Ve al Inicio de Sesion</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
