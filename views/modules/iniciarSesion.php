                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <a class="btn btn-primary" onclick="iniciarSesion()" href="../template.php">Iniciar Sesion</a>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="registroUsuario.php">Need an account? Sign up!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
