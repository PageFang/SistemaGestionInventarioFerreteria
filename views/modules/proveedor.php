                                ...
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form form id="formProveedor" onsubmit="return insertarProveedor()" method="POST"> 
                                                                    ...
                                                                    <input type="text" id="telefonoUp" name="telefonoUp" class="form-control form-control-sm" required="">

                                                                    <br>
                                                                    <label>Ciudad : </label>
                                                                    <select name="ciudadProveedorUp" id="">
                                            ...
                                            <div class="col">
                                                <div class="modal" id="actualizarModalProveedor">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form form id="frminsertUp" onsubmit="return actualizarProducto()" method="POST"> 
                                                                    ...
                                                                    <label>Telefono</label>
                                                                    <input type="text" id="marcaUp" name="marcaUp" class="form-control form-control-sm" equired="" maxlength="10">
                                                                    <br>
                                                                    <label>Ciudad : </label>
